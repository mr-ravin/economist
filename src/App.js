import './App.css';
import researchpaper from "./AddictiveAuctions.pdf"
function App() {
  return (
    <div>
    <center><h1><b><i> Economist's Life </i></b></h1></center>
   <br/>
   <div class="middle">
     <ol>
    <li>
    <b><u><a href={researchpaper} target="_blank" rel="noopener noreferrer" style={{color:"black"}}>Addictive auctions: Using lucky-draw and gambling addiction to increase participation during auctioning</a></u></b>,<br/>
     DOI Number: <a href="https://doi.org/10.51483/IJMRE.1.1.2021.68-74" target="_blank" rel="noopener noreferrer">10.51483/IJMRE.1.1.2021.68-74</a>
     ...
     <li>Fetch paper from github: <a target="_blank" rel="noopener noreferrer" href={researchpaper}>click here</a></li>
